...
| Piano Roll    | `.piano`, `.piano-keys`, `.note-grid`, `.harmony-panel`, `.editor-footer`                               | `PianoRollView`; note mutations stay in `usePianoRollActions` and `ProjectSession`                              |
...
| Arrangement   | `.arrange`, `.track-heads`, `.arrange-grid`, `.arrange-context`                                         | `ArrangementView`; clip mutations stay in `useArrangementActions` and `ProjectSession`                          |
