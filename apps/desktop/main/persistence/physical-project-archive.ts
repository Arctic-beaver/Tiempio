...
function archiveError(message: string, tooLarge = false): PersistenceBoundaryError {
	return new PersistenceBoundaryError(tooLarge ? 'PROJECT_TOO_LARGE' : 'PROJECT_INVALID', message)
}
